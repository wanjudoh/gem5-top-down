...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < iterations; i++) {
        __asm__ __volatile__("fdiv.d f0, f0, f0");
        __asm__ __volatile__("fdiv.d f1, f1, f1");
        __asm__ __volatile__("fdiv.d f2, f2, f2");
        __asm__ __volatile__("fdiv.d f3, f3, f3");
        __asm__ __volatile__("fdiv.d f4, f4, f4");
        __asm__ __volatile__("fdiv.d f5, f5, f5");
        __asm__ __volatile__("fdiv.d f6, f6, f6");
        __asm__ __volatile__("fdiv.d f7, f7, f7");
